...
namespace TrueSync.Physics2D
{
	public static class BodyFactory
	{
		...
		{
			Body body = BodyFactory.CreateBody(world, null);
		...
		{
			return BodyFactory.CreateChainShape(world, vertices, TSVector2.zero, userData);
		}
		...
		public static Body CreateEllipse(World world, FP xRadius, FP yRadius, int edges, FP density, TSVector2 position, object userData = null)
		{
			Body body = BodyFactory.CreateBody(world, position);
		...
		public static Body CreateCapsule(World world, FP height, FP endRadius, FP density, object userData = null)
		{
			Vertices item = PolygonTools.CreateRectangle(endRadius, height / 2);
			Body body = BodyFactory.CreateCompoundPolygon(world, new List<Vertices>
			{
				item
			}, density, userData);
			body.UserData = userData;
			body.CreateFixture(new CircleShape(endRadius, density)
			{
