namespace Microsoft.Xna.Framework
{
    ...
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        {
            FP fp;
            DistanceSquared(ref vector1, ref vector2, out fp);
            return FP.Sqrt(fp);
        }
        ...
        {
            FP fp;
            DistanceSquared(ref this, ref zero, out fp);
            return FP.Sqrt(fp);
        }
        ...
        {
            FP fp;
            Distance(ref value, ref zero, out fp);
            fp = 1f / fp;
            result.X = value.X * fp;
            result.Y = value.Y * fp;
            result.Z = value.Z * fp;
        ...
        public static void Reflect(ref Vector3 vector, ref Vector3 normal, out Vector3 result)
        {
            ...
            result.Z = vector.Z - ((2f * fp) * normal.Z);
        }
